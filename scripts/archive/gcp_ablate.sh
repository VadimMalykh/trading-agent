...
gcloud storage cp \"\$GCS_BUCKET/dumps/latest.sql.gz\" \$HOME/fluxtrader-train-export/fluxtrader_ablate.sql.gz
echo \"    dump ready → \$HOME/fluxtrader-train-export/fluxtrader_ablate.sql.gz\"
