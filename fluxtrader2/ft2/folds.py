...
F0 is warm-up: the earliest data, used only as training history for the folds after it (a
walk-forward fit for F1 needs something before F1). F1 and F2 are the exploration folds; F3,
