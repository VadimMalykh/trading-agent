...
## ⚫ The B-wave's first pass, 2026-08-29 → 08-31 — SUPERSEDED 2026-09-10

**Why it is here.** Every number below was measured on the 2026-08-05..27 export, whose 5m
candles were the collector's **partial bars** (`docs/CANDLE_POLL_DEFECT.md`: from 2026-07-18
to 09-03 every stored candle was a snapshot of the bar's first minute). The forward returns
B1 ranked and the drift B1 subtracted were therefore not the market's. The 2026-09-10 re-run
on the repaired candles over the full era (2026-07-17..09-09) replaces them; see
`docs/BOOK_ERA_PLAN.md` §R. The *design* of B0–B2 was right and is unchanged; only the inputs
were defective. Kept for the reasoning and for the "NOT EVALUABLE ≠ FAIL" argument, which
turned out to matter: the gate that could not run on 23 days passed on 54.

### B0, as recorded 2026-08-29
