...
🔴 **Mode as of 2026-09-16: a defect is open and a GPU wave is queued. Needed from Vadim:
launch U12's three runs (row 10) — the exact commands are in that row.** The served checkpoint
