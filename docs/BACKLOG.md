...
them — they are offline.* **Needed from Vadim: two decisions. (1) Whether to add the R5 forward reading (X4's row) —
recommended yes, it is free. (2) Whether to fund X2 (GPU, its 3-seed control X0 is banked) —
the last offline lever with a rationale; X5 is hygiene. X1 (WORSE), X3 (gate not passed) and
X4 (not confirmed, sign consistent) all closed 2026-09-15.**
